...
public abstract class MarigoldAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    public MarigoldAdapter(Context context) {
        this.mContext = context.getApplicationContext();
        setHasStableIds(true);
    }

    public MarigoldAdapter(Context context, ArrayList<Message> messages) {
        this(context);
    ...
    @Override
    public abstract @NotNull VH onCreateViewHolder(ViewGroup parent, int viewType);
