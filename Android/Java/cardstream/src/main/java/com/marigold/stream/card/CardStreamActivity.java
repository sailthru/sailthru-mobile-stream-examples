...
public class CardStreamActivity extends AppCompatActivity {

    private static final String TAG = CardStreamActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey(BUNDLE_MESSAGES)) {
            ...
            if (messages == null || messages.isEmpty()) {
                ...
                mAdapter = new CardAdapter(this, messages);
        ...
        SwipeableRecyclerViewTouchListener swipeTouchListener =
                new SwipeableRecyclerViewTouchListener(mRecyclerView, new MarigoldSwipeListener());
    ...
    private class CardAdapter extends MarigoldAdapter<CardViewHolder> {

        public CardAdapter(Context context) {
            super(context);
        }

        public CardAdapter(Context context, ArrayList<Message> messages) {
        ...
        public @NotNull CardViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            CardTextBinding binding = CardTextBinding.inflate(layoutInflater);
        ...
        public void onBindViewHolder(CardViewHolder holder, int position, Message message) {
            ...
            CardTextBinding binding = holder.mBinding;
    ...
    private class CardViewHolder extends RecyclerView.ViewHolder {
        ...
        CardTextBinding mBinding;

        public CardViewHolder(CardTextBinding binding) {
    ...
    private class MarigoldSwipeListener implements SwipeableRecyclerViewTouchListener.SwipeListener {
        ...
        private void deleteMessageBySwipe(final Message message) {
            new MessageStream().deleteMessage(message, new MessageStream.MessageDeletedHandler() {
                @Override
