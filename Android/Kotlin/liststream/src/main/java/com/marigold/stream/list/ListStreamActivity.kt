package com.marigold.stream.list
...
import com.marigold.stream.list.databinding.TileCompactBinding
...
class ListStreamActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
         ...
         */if (savedInstanceState != null && savedInstanceState.containsKey(BUNDLE_MESSAGES)) {
            ...
            if (messages.isNullOrEmpty()) {
                ...
                mAdapter = ListAdapter(this, messages)
    ...
    private inner class ListAdapter : MarigoldAdapter<CardViewHolder> {
        constructor(context: Context) : super(context)
        constructor(context: Context, messages: ArrayList<Message>?) : super(context, messages)

        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CardViewHolder {
            val layoutInflater = LayoutInflater.from(applicationContext)
            val binding = TileCompactBinding.inflate(layoutInflater)
        ...
        override fun onBindViewHolder(holder: CardViewHolder, position: Int, message: Message?) {
            ...
            val mediaImageView = binding.mediaImageView
     ...
     */
    private inner class CardViewHolder(var mBinding: TileCompactBinding) : RecyclerView.ViewHolder(
        mBinding.root
    ) {
        init {
    ...
    companion object {
        private val TAG = ListStreamActivity::class.java.getSimpleName()
