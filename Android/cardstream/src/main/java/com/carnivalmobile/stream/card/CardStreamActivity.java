package com.carnivalmobile.stream.card;
...
import com.carnivalmobile.stream.card.databinding.CardTextBinding;
...
public class CardStreamActivity extends AppCompatActivity {
    ...
    private class CardAdapter extends CarnivalAdapter<CardViewHolder> {
